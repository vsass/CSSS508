...
**Office Hours:** Wednesdays 3-5pm (Zoom - link on [Canvas](https://canvas.uw.edu/courses/1665088))
...
-   **Office Hours (remote; One 2-hour session):** On Wednesdays, I will hold drop-in office hours on Zoom. This is a great time to ask questions, get advice, or continue discussions from lab/lecture. We can talk in a breakout room or with the group! A link to the Zoom meeting can be found on [Canvas](https://canvas.uw.edu/courses/1665088).
