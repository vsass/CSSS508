...
**Office Hours:** Wednesdays 1pm-3pm on Zoom (link on {{< var canvas >}})
...
-   **Office Hours (remote; one 2-hour session):** On Wednesdays, I will hold drop-in office hours on Zoom from 1-3pm. This is a great time to ask questions, get advice, or continue discussions from lecture. We can talk in a breakout room or with the group! A link to the Zoom meeting can be found on {{< var canvas >}}.
