...
[^longnote1]: You can set the `echo: false` (and other) code chunk option globally (will set it as the document default) by specifying it in your YAML header like so: 
