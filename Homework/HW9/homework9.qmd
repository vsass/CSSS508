...
### Instructions
Answer each of the following questions using the iterative techniques covered in lecture. Be sure to display **all your code in the rendered** version (use `echo: true` throughout[^longnote]). 
