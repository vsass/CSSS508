...
* Use `setwd()` in scripts or .qmd files.
...
The most important method of selecting from dataframes is selecting rows and columns with `df[rows, cols]`. 
