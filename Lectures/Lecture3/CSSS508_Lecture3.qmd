...
![](images/rstudio-pipe-options.png){fig-align="center" width=70%}
...
* **Reprex**
  ...
  + You can use the [`reprex`](https://reprex.tidyverse.org/) package for assistance with this! 
...
1. Organize your files for this class in a way that facilitates reproducible research. 
    i) For this current homework, begin by first creating a project for "Homework3"^[The specific titles used to name your files/folders can be whatever you want as long as they're descriptive and consistent in their naming conventions.].
    ii) For homeworks 1 and 2, make sure they each have their own folder within a folder for this class.
    iii) Retroactively turn those folders into projects in RStudio by selecting *File* > *New Project...* > *Existing Directory* and selecting the appropriate folder for each homework. Then close each project.
    ...
    v) When you're done organizing the folder for this class, write out its current organizational structure (i.e. something similar to the solution to lab question 5 with the specific names for files and folders that *you* used. 
