...
Note these data are *fairly large* in the native `.csv` format. The following code can be used to download the data directly from my `Github` page as smaller, `.Rdata` object:

```{r}
load(url("https://vsass.github.io/CSSS508/Lectures/Lecture7/restaurants.Rdata"))
```
