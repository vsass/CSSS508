---
date-format: long
highlight-style:  a11y-dark #, oblivion, radical, vim-dark, espresso, zenburn, breezedark, haddock; atom-one-dark-reasonable, # nord
...
## {#title-slide data-menu-title="Workflow & Best Practices" background="#1e4655" background-image="../../images/csss-logo.png" background-position="center top 5%" background-size="50%"}

[Workflow & Best Practices]{.custom-title}

[CS&SS 508 • Lecture 10]{.custom-subtitle}

[15 December 2023]{.custom-subtitle2}
...
* *File* > *New Project...*
* ![](images/rproject_icon.png){vertical-align="bottom"} in the upper-left corner of RStudio
