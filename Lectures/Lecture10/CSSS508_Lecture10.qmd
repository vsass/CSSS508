...
2. There is an excellent book online by Max Kuhn and Julia Silge called [Tody Modeling with R]() that provides a great overview of how to approach modeling within a tidy framework and well as showing how to use the various packages within `tidymodels`. 
...
Once we have data we want to visualize we can call `ggpmap` to visualize the spatial area and layer on any geoms/stats as you would with `ggplot2.` 
