...
# Preamble: Data Structures and Types in `R` {.section-title background-color="#99a486"}
...
For Homework 6, you will fill in an Quarto template on our [course website](https://vsass.github.io/CSSS508/Homework/HW4/homework6.html) that walks you through the process of creating, accessing, and manipulating R data structures. Enter values in the qmd document and Render it to check your answers!
...
base_schedule |> 
  ...
  tab_style(style = cell_borders(sides = c("bottom", "top"),  weight = px(3), color = "#1e4655"),
            locations = cells_body(rows = Homework == 6)) |> 
  ...
  # Adding color to due date row
  tab_style(style = cell_fill(color = "#c7cdac"),
            locations = cells_body(columns = c(Due_Date_AA, Due_Date_AB), 
                                   rows = Homework == 6)) |> 
  tab_style(style = cell_fill(color = "#99a486"),
            locations = cells_body(columns = c(Peer_Due_Date_AA, Peer_Due_Date_AB), 
                                   rows = Homework == 6))
```