...
# Wrangling Date/Date-Time Data {.section-title background-color="#99a486"}

# Dates and Times {background-image="images/lubridate.png" background-size="contain" background-position="center" .section-title background-color="#1e4655"}
