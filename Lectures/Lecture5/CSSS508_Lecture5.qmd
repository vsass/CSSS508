...
# Reshaping Data {background-image="images/tidyr.svg" background-size="contain" background-opacity="0.25" background-position="right"}
...
# Dates and Times {background-image="images/lubridate.svg" background-size="contain" background-opacity="0.25" background-position="right"}
