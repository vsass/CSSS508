...
:::{.incremental}
* `.qmd`^[Quarto builds on a decade of developments with R Markdown documents, or .Rmd files. .Rmd fils operate very similarly to Quarto documents but there are some differences which you can read more about [here](https://quarto.org/docs/computations/r.html#:~:text=Another%20difference%20between%20R%20Markdown,than%20relying%20on%20external%20packages)]: These are **markdown** *syntax* files, where you write code and prose to *make documents*.
