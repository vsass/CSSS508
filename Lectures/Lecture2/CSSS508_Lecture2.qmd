...
9. Add one of the built-in themes from `ggplot2`.

## Solution

### 1: Set Base Layer {auto-animate="true"}
...
### 2: Add Histogram Layer {auto-animate="true"}
...
### 3: Add Label Layers {auto-animate="true"}
...
### 4: Adding fill setting {auto-animate="true"}
...
### 5: Adding fill aesthetic {auto-animate="true"}
...
### 6: Changing geometry {auto-animate="true"}
...
### 7: Adding facets {auto-animate="true"}
...
### 8: Repositioning legend {auto-animate="true"}
...
* You can use other `geoms` like bar charts, box plots, adding meaningful vertical or horizontal lines, etc. [You may find this data visualization cheat sheet helpful](https://rstudio.github.io/cheatsheets/data-visualization.pdf).
