...
**Labs:** *An more interactive session where we will practice the skills from lecture. Towards the end of these sections students will work with each other to learn and practice key skills in R, but I will be available to help as well!*
...
**Office Hours:** Drop-in to ask questions, get advice, or continue discussions from lab/lecture. We can talk in a breakout room or with the group! 
  ...
  * Wednesdays, 3-5pm (on Zoom; link on [Canvas](https://canvas.uw.edu/courses/1665088))

**Contact:** [Message me](https://csss-508-fall-2023.slack.com//archives/D05TVTE2926) in our [Slack workspace](https://csss-508-fall-2023.slack.com/) rather than sending me an email. *I get far too many emails a day and I don't want to miss your message!*
...
**Getting Help:** If at any point during the quarter you find yourself struggling to keep up, please let me know! I am here to help. A great place to start this process is by chatting after class, coming to office hours, or sending me a message on [Slack](https://csss-508-fall-2023.slack.com/archives/D05TVTE2926). 
...
7. Some content may be scrollable (like this page!). If this is the case I will put the <span style="color:#99a486">{{< fa scroll >}}</span> icon in the title to let you know. 
:::
...
#### Cheatsheets
* RStudio: [**Website**](https://rstudio.github.io/cheatsheets/html/rstudio-ide.html?_gl=1*1drxtw*_ga*MTY0ODE1MTE3NS4xNjkzNzA5NjI0*_ga_2C0WZ1JHG0*MTY5NjE5ODA1NS43LjAuMTY5NjE5ODA1NS4wLjAuMA..) • [**PDF**](https://rstudio.github.io/cheatsheets/rstudio-ide.pdf)
* Quarto: [**Website**](https://rstudio.github.io/cheatsheets/html/quarto.html?_gl=1*qigh6d*_ga*MTY0ODE1MTE3NS4xNjkzNzA5NjI0*_ga_2C0WZ1JHG0*MTY5NjE5ODA1NS43LjEuMTY5NjE5ODE1OC4wLjAuMA..) • [**PDF**](https://rstudio.github.io/cheatsheets/quarto.pdf)
* Base `R`: [**PDF**](https://rstudio.github.io/cheatsheets/base-r.pdf)
  
#### Additional Reading
[Hands-On Programming with R](https://rstudio-education.github.io/hopr/) - *A great book for someone with no experience with `R` or programming*
