...
## {#title-slide data-menu-title="Syllabus and Introduction to R, RStudio, and Quarto" background="#1e4655" background-image="../../images/csss-logo.png" background-position="center top 5%" background-size="50%"}
