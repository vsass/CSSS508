...
**Course Website:** [https://vsass.github.io/CSSS508](https://vsass.github.io/CSSS508)
...
rubric <- tibble(Evaluation = c("Didn't turn anything in.", 
...
rubric |> 
  ...
  tab_options(table.align = "center", table.font.names = c("Quattrocento", "Raleway"), 
              table.font.size = pct(125), table.border.top.style = "hidden",) |>
...
schedule |> 
  ...
  tab_style(style = cell_borders(sides = c("bottom", "top"),  weight = px(4)),
            locations = cells_body(rows = Homework == 1)) |> 
  tab_style(style = cell_borders(sides = "left",  weight = px(4)),
            locations = cells_body(rows = Homework == 1, 
                                   columns = Homework)) |> 
  tab_style(style = cell_borders(sides = "right",  weight = px(4)),
            locations = cells_body(rows = Homework == 1, 
