...
Form a group of 3-5 with the people seated around you and introduce yourself to one another.
...
Learning is collaborative! In addition to being the place to communicate with me, our [Slack Workplace](https://uw-csss-508.slack.com/) is also where you can ask one another questions, share resources, and just generally vibe with each other about how your adventures with `R` are going. You can find the link to join our workplace on the our course [Canvas page](https://canvas.uw.edu/courses/1665088).
...
Learning is collaborative! In addition to being the place to communicate with me, our [Slack Workplace](https://uw-csss-508.slack.com/) is also where you can ask one another questions, share resources, and just generally commiserate with each other about how your adventures with `R` are going. You can find the link to join our workplace on the our course [Canvas page](https://canvas.uw.edu/courses/1665088).
...
# Data Frames{.section-title background-color="#99a486"}
