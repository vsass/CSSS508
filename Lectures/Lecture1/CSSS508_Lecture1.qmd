...
6. Clicking on the <span style="color:#1e4655">{{< fa paintbrush >}}</span> in the bottom left-hand corner allows you to draw directly on the slides, in a very Microsoft Paint kind of way. See if it's useful but I make no promises!
7. Type **?** at any time to see all the available key-board shortcuts. 
8. Some content may be scrollable (like this page!). If this is the case I will put the <span style="color:#99a486">{{< fa scroll >}}</span> icon in the title to let you know. 
:::
