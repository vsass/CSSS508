...
* [`gssr`](https://kjhealy.github.io/gssr/): The General Social Survey Cumulative Data (1972-2021) and Three Wave Panel Data
...
`readr` is one of the core `tidyverse packages so if you load the tidyverse you will have access to it:
...
Alternatively, you can simply load just `readr` like so:
...
```{r}
billboard_2000_raw <- read_csv(file = "https://raw.githubusercontent.com/vsass/CSSS508/main/Lectures/Lecture4/data/billboard.csv")
```
