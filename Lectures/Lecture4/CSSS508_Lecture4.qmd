...
## Homework 4 <span style="color:#99a486">{{< fa scroll >}}</span> {.scrollable} 

Answer each of the following questions. Be sure to display **all your code in the knitted** version (use `echo: false` throughout[^longnote]). 
